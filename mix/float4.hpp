...
struct float4_e2m1_t {
    ...
    float4_e2m1_t &operator=(float f);
    // float4_e2m1_t &operator=(float16_t f);
    // float4_e2m1_t &operator=(bfloat16_t f);
